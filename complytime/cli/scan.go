...
func runScan(cmd *cobra.Command, opts *scanOptions) error {
	...
	fmt.Printf("Assessment results format %s\n", opts.complyTimeOpts.OutputFormat)
	assessmentResultsLocation := strings.Join([]string{"assessment-results", opts.complyTimeOpts.OutputFormat}, ".")
	...
	if err != nil {
		return err
		fmt.Printf("Assessment results err %s\n", err)
	}
